...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> placeOrder(
        ...
        return ResponseEntity.ok(new ApiResponse<>(201, "Order created successfully", order, null, LocalDateTime.now()));
    }
...
//    }
    ...
    public ResponseEntity<ApiResponse<String>> deleteOrder(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, message, null, null, LocalDateTime.now()));
    }
}
